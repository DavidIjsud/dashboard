...
class NetworkClient {
  NetworkClient({required SecureStorage secureStorage, required http.Client client})
  ...
  Future<http.Response> patch(Uri uri, {String? body, Map<String, String>? headers}) async {
    final response = await _client.put(uri, headers: {}, body: body);

    return response;
  }

  Future<http.Response> post(Uri uri, {String? body, Map<String, String>? headers}) async {
    final response = await _client.put(uri, headers: {}, body: body);
